...
<View style = {{width: props.BoxWidth, height: props.BoxHeight, justifyContent: 'center', alignItems: 'center', 
              ...
              {props.IsTextBox && 
              <TextInput style = {[styles._Text, {width: '100%', height: '100%',paddingLeft: 20, color: props.LocTitleColor, fontSize: props.FontSize}]} 
                                  placeholder = {props.LocTitle} placeholderTextColor = {'#9B9B9B'} ref = {props.ControlName}
                                  value = {props.Value} numberOfLines = {2} multiline = {props.MultiLine} keyboardType = {props.KeyboardType}
                                  onChangeText = {(v)=>{props.OnChangeFunction(v)}}/>
              }
