...
import QoutesDetails from './QoutesDetails';
import MoveBids from './MoveBids';
...
export default class QoutesControl extends Component {
  state = {
    index: LoginData.CurrentPage,
    lastRefresh: 1,
    routes: [
  ...
  _renderScene = ({ route, jumpTo }) => {
    switch (route.key) {
   case 'Details':
    return <QoutesDetails navigation={this.props.navigation}  jumpTo={jumpTo} />;
    case 'Bids':
      return <MoveBids navigation={this.props.navigation}  jumpTo={jumpTo} self={this}/>;
    }
  }
