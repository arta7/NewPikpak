...
import ActiveMoveDetails from './ActiveMoveDetails';
...
export default class ActiveMoveControl extends Component {
  state = {
    index: 0,
    routes: [
  ...
  _renderScene = ({ route, jumpTo }) => {
    switch (route.key) {
   case 'Details':
    return <ActiveMoveDetails navigation={this.props.navigation}  jumpTo={jumpTo} />;
      case 'Messages':
...
<View style={{flex:1}}>
<Headers HeaderHeight = {hp('6.5%')} HeaderTitle = {'Active Move'} 
